class Admin::MailboxMessagesController < Admin::DashboardController
  ...
  def create
    ...
    redirect_to admin_mailbox_message_path(receipt.conversation)
  end
  ...
  def trash
    ...
    redirect_to admin_mailbox_messages_path(box: params[:current_box])
  end
  ...
  def untrash
    ...
    redirect_to admin_mailbox_messages_path(box: 'inbox')
  end
